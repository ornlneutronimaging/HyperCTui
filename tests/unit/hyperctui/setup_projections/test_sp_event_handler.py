"""Unit tests for the setup_projections event_handler module."""

import pytest

from hyperctui.setup_projections.event_handler import EventHandler


class TestEventHandler:
    """Tests for the setup_projections EventHandler class."""
